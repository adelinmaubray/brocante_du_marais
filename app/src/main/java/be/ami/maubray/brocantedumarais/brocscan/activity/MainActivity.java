package be.ami.maubray.brocantedumarais.brocscan.activity;
...
import be.ami.maubray.brocantedumarais.brocscan.database.ClassHandler;
import be.ami.maubray.brocantedumarais.brocscan.database.DatabaseHandler;
...
import be.ami.maubray.brocantedumarais.brocscan.scanner.Scanner;
...
public class MainActivity extends AppCompatActivity {
	...
	// Buttons
	private final RadioButton[] entries = new RadioButton[5];
	// The databaseHandler
